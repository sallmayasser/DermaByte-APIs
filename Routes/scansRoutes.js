...
router
  .route('/')
  .post(authController.protect,authController.allowedTo("patient"),getLoggedUserData,functions.uploadScanImage,functions.resizeScanImage,functions.setPatientIdToBody, functions.createScan)
